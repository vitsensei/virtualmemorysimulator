...
int main(int argc, char* argv[])
{
	...
	if (strcmp(argv[3],"SC") == 0)
	{
		...
		while (iter != NULL)	//iterate through all the instruction.
		{
			...
			for (i=1;i<num_of_pages;i++) // if you have 4 pages to iterate through, you only need the iterF = iterF -> next instruction to run 3 times.
			{
